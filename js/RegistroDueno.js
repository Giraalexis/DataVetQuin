...
btnRegistrar.addEventListener('click',()=>{
  let rut = document.getElementById("txt-rut").value.trim();
  let nombre = document.getElementById("txt-nombre").value.trim();
  let apel_p = document.getElementById("txt-apel_p").value.trim();
  let apel_m = document.getElementById("txt-apel_m").value.trim();
  let fech_nac = document.getElementById("txt-fecha_nac").value.trim();
  let correo = document.getElementById("txt-correo").value.trim();
  let fono = document.getElementById("txt-fono").value.trim();
